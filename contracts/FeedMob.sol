...
contract FeedMob is ERC721Enumerable, Ownable {
    //supply counters
    uint64 public totalCount = 1000000;
    mapping (uint256 => uint256) private _tokenURIs;
    mapping (address => bool) private _whiteList;

    modifier onlyWhiteList() {
        require(_whiteList[_msgSender()], "Feedmob: caller is not in the whitelist");
        _;
    }

    constructor() ERC721("FeedMob", "FMB") {}
